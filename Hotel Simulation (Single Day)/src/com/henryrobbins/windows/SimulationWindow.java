	...
	public SimulationWindow() {
		...
		typeChoose.addActionListener(e -> {
			...
			if (type[0].equals("Instance")) {
				...
				instanceConfig();
				arrivalsLbl.setVisible(false);
				arrivalsChooseBtn.setVisible(false);
				arrivalsFileLbl.setVisible(false);
				weightsLbl.setVisible(false);
				weightsChooseBtn.setVisible(false);
				weightsFileLbl.setVisible(false);
...
//			if (resultDirPath == null) { throw new IllegalArgumentException(); }
